...
// Generated on 11/8/2025 at 13:15:46
// Library Name: MotionEstimator
// Block Name: top
// User Label: 
// Write Command: write_verilog -top_module_first ./outputs/ME.v
...
control ctl_u ( .clock ( ZCTSNET_3 ) , .start ( start ) ,
...
PEtotal pe_u ( .clock ( ZCTSNET_0 ) , .R ( R ) , .S1 ( S1 ) , .S2 ( S2 ) ,
    ...
    .ZCTSNET_1 ( ZCTSNET_1 ) , .ZCTSNET_2 ( ZCTSNET_2 ) , 
    .ZCTSNET_3 ( ZCTSNET_3 ) , .ZCTSNET_5 ( clock ) , .p2 ( optlc_net_17 ) , 
    .p3 ( optlc_net_18 ) ) ;
Comparator comp_u ( .clock ( ZCTSNET_0 ) , .CompStart ( CompStart ) , 
    ...
    .ZCTSNET_1 ( ZCTSNET_2 ) , .ZCTSNET_2 ( clock ) ) ;
SAEDRVT14_TIE0_4 optlc_2550 ( .X ( AddressS1[4] ) ) ;
SAEDHVT14_TIE1_V1_2 optlc_2551 ( .X ( AddressS2[4] ) ) ;
SAEDHVT14_TIE1_V1_2 optlc_2554 ( .X ( optlc_net_17 ) ) ;
SAEDHVT14_TIE1_V1_2 optlc_2556 ( .X ( optlc_net_18 ) ) ;
SAEDRVT14_BUF_S_6 ZCTSBUF_1274_10 ( .A ( clock ) , .X ( ZCTSNET_0 ) ) ;
SAEDRVT14_DEL_R2V1_2 ZCTSBUF_1520_11 ( .A ( clock ) , .X ( ZCTSNET_1 ) ) ;
SAEDRVT14_BUF_S_6 ZCTSBUF_2231_12 ( .A ( clock ) , .X ( ZCTSNET_2 ) ) ;
SAEDRVT14_BUF_10 ZCTSBUF_3432_14 ( .A ( clock ) , .X ( ZCTSNET_3 ) ) ;
endmodule
...
SAEDRVT14_AN2_MM_0P5 U21 ( .A1 ( CompStart ) , .A2 ( newDist[7] ) , 
    .X ( PEready[7] ) ) ;
SAEDRVT14_AN2_MM_0P5 U23 ( .A1 ( CompStart ) , .A2 ( newDist[6] ) , 
    .X ( PEready[6] ) ) ;
SAEDRVT14_NR3_0P5 U24 ( .A1 ( AddressS1[0] ) , .A2 ( n13 ) , .A3 ( n147 ) , 
    .X ( newDist[6] ) ) ;
...
SAEDRVT14_AN2_MM_0P5 U35 ( .A1 ( CompStart ) , .A2 ( newDist[1] ) , 
    .X ( PEready[1] ) ) ;
SAEDRVT14_AN3_0P5 U36 ( .A1 ( n12 ) , .A2 ( AddressS1[0] ) , .A3 ( n19 ) , 
    .X ( newDist[1] ) ) ;
...
SAEDRVT14_AN2_MM_0P5 U46 ( .A1 ( CompStart ) , .A2 ( newDist[12] ) , 
    .X ( PEready[12] ) ) ;
SAEDRVT14_NR3_0P5 U47 ( .A1 ( n142 ) , .A2 ( n148 ) , .A3 ( n146 ) , 
    .X ( newDist[12] ) ) ;
...
SAEDRVT14_AN2_MM_0P5 U56 ( .A1 ( CompStart ) , .A2 ( newDist[0] ) , 
    .X ( PEready[0] ) ) ;
SAEDRVT14_OR4_1 U61 ( .A1 ( AddressR[5] ) , .A2 ( AddressR[4] ) , 
    .A3 ( AddressR[7] ) , .A4 ( AddressR[6] ) , .X ( n148 ) ) ;
control_DW01_inc_0 add_108 (
...
SAEDRVT14_FSDPQ_V2LP_0P5 \count_reg[1] ( .D ( count_temp[1] ) , 
    .SI ( start ) , .SE ( n134 ) , .CK ( clock ) , .Q ( AddressS1[1] ) ) ;
SAEDRVT14_FSDPQ_V2LP_0P5 \count_reg[0] ( .D ( count_temp[0] ) , 
    .SI ( start ) , .SE ( n134 ) , .CK ( clock ) , .Q ( AddressS1[0] ) ) ;
...
SAEDRVT14_FDPCBQ_V2LP_1 \count_reg[8] ( .D ( n7 ) , .RS ( count_temp[8] ) , 
    .CK ( clock ) , .Q ( count[8] ) ) ;
SAEDRVT14_ADDF_V1_0P5 \add_121/U1_3 ( .A ( tmp_net12 ) , .B ( temp[7] ) , 
    .CI ( \add_121/carry[3] ) , .CO ( AddressS2[9] ) , .S ( AddressS2[8] ) ) ;
SAEDRVT14_ADDF_V1_0P5 \add_118/U1_3 ( .A ( count[11] ) , .B ( AddressR[7] ) , 
    .CI ( \add_118/carry[3] ) , .CO ( AddressS1[9] ) , .S ( AddressS1[8] ) ) ;
SAEDRVT14_ADDF_V1_0P5 \add_121/U1_2 ( .A ( temp[10] ) , .B ( temp[6] ) , 
    .CI ( \add_121/carry[2] ) , .CO ( \add_121/carry[3] ) , 
    .S ( AddressS2[7] ) ) ;
SAEDRVT14_ADDF_V1_0P5 \add_118/U1_1 ( .A ( count[9] ) , .B ( AddressR[5] ) , 
    .CI ( \add_118/carry[1] ) , .CO ( \add_118/carry[2] ) , 
    .S ( AddressS1[6] ) ) ;
SAEDRVT14_ADDF_V1_0P5 \add_118/U1_2 ( .A ( count[10] ) , .B ( AddressR[6] ) , 
    .CI ( \add_118/carry[2] ) , .CO ( \add_118/carry[3] ) , 
    .S ( AddressS1[7] ) ) ;
SAEDRVT14_ADDF_V1_0P5 \add_121/U1_1 ( .A ( temp[9] ) , .B ( temp[5] ) , 
    .CI ( \add_121/carry[1] ) , .CO ( \add_121/carry[2] ) , 
    .S ( AddressS2[6] ) ) ;
SAEDSLVT14_TIE1_4 U3 () ;
SAEDSLVT14_TIE0_V1_2 U6 () ;
SAEDRVT14_INV_S_0P5 U7 ( .A ( n136 ) , .X ( newDist[15] ) ) ;
SAEDRVT14_NR2_MM_0P5 U10 ( .A1 ( n11 ) , .A2 ( n136 ) , .X ( PEready[15] ) ) ;
SAEDHVT14_NR2_MM_0P5 U12 ( .A1 ( n147 ) , .A2 ( n146 ) , .X ( newDist[4] ) ) ;
SAEDHVT14_ND2_MM_0P5 U13 ( .A1 ( S1S2mux[15] ) , .A2 ( n19 ) , .X ( n136 ) ) ;
SAEDHVT14_NR2_MM_0P5 U14 ( .A1 ( n11 ) , .A2 ( n138 ) , .X ( PEready[2] ) ) ;
SAEDRVT14_INV_S_1 U15 ( .A ( n138 ) , .X ( newDist[2] ) ) ;
SAEDRVT14_INV_S_0P5 U16 ( .A ( S1S2mux[4] ) , .X ( n15 ) ) ;
SAEDRVT14_INV_S_0P5 U18 ( .A ( S1S2mux[2] ) , .X ( n12 ) ) ;
SAEDHVT14_ND2_MM_0P5 U20 ( .A1 ( n140 ) , .A2 ( n21 ) , .X ( n137 ) ) ;
SAEDRVT14_INV_S_0P5 U22 ( .A ( n148 ) , .X ( n19 ) ) ;
SAEDRVT14_INV_0P5 U26 ( .A ( CompStart ) , .X ( n11 ) ) ;
SAEDHVT14_ND2_MM_0P5 U28 ( .A1 ( n149 ) , .A2 ( n8 ) , .X ( n138 ) ) ;
SAEDHVT14_NR2_1 U30 ( .A1 ( n145 ) , .A2 ( n147 ) , .X ( newDist[5] ) ) ;
SAEDHVT14_NR2_MM_0P5 U31 ( .A1 ( n144 ) , .A2 ( n146 ) , .X ( newDist[8] ) ) ;
SAEDHVT14_NR2_MM_0P5 U32 ( .A1 ( n144 ) , .A2 ( n145 ) , .X ( newDist[9] ) ) ;
SAEDRVT14_NR2_MM_0P5 U33 ( .A1 ( n141 ) , .A2 ( n147 ) , .X ( newDist[7] ) ) ;
SAEDHVT14_NR2_MM_0P5 U37 ( .A1 ( n144 ) , .A2 ( n141 ) , .X ( newDist[11] ) ) ;
SAEDHVT14_NR2_MM_0P5 U38 ( .A1 ( n11 ) , .A2 ( n139 ) , .X ( PEready[3] ) ) ;
SAEDRVT14_INV_S_1 U39 ( .A ( n139 ) , .X ( newDist[3] ) ) ;
SAEDRVT14_OAI21_0P5 U42 ( .A1 ( n16 ) , .A2 ( n13 ) , .B ( VectorX[3] ) , 
    .X ( S1S2mux[6] ) ) ;
SAEDRVT14_OAI21_0P5 ctmTdsLR_2_2540_roptpi_2548 ( .A1 ( n141 ) , .A2 ( n16 ) , 
    .B ( VectorX[3] ) , .X ( S1S2mux[7] ) ) ;
SAEDHVT14_ND2_MM_0P5 U48 ( .A1 ( n16 ) , .A2 ( VectorX[3] ) , 
    .X ( S1S2mux[4] ) ) ;
SAEDRVT14_INV_S_0P5 U49 ( .A ( n142 ) , .X ( S1S2mux[12] ) ) ;
SAEDRVT14_OAI21_0P5 U51 ( .A1 ( VectorX[3] ) , .A2 ( n13 ) , .B ( n142 ) , 
    .X ( S1S2mux[10] ) ) ;
SAEDRVT14_OAI21_0P5 U52 ( .A1 ( n142 ) , .A2 ( n8 ) , .B ( n143 ) , 
    .X ( S1S2mux[13] ) ) ;
SAEDRVT14_INV_S_0P5 U57 ( .A ( n143 ) , .X ( S1S2mux[14] ) ) ;
SAEDHVT14_ND2_MM_0P5 U58 ( .A1 ( n12 ) , .A2 ( n8 ) , .X ( S1S2mux[1] ) ) ;
SAEDHVT14_NR2_MM_0P5 U59 ( .A1 ( n8 ) , .A2 ( n143 ) , .X ( S1S2mux[15] ) ) ;
SAEDHVT14_ND2_MM_0P5 U60 ( .A1 ( n15 ) , .A2 ( n13 ) , .X ( S1S2mux[2] ) ) ;
SAEDHVT14_ND2_MM_0P5 U62 ( .A1 ( n13 ) , .A2 ( n8 ) , .X ( n146 ) ) ;
SAEDRVT14_INV_S_0P5 U63 ( .A ( AddressS2[3] ) , .X ( VectorX[3] ) ) ;
SAEDRVT14_INV_S_0P5 U64 ( .A ( n134 ) , .X ( n7 ) ) ;
SAEDRVT14_OAI21_0P5 ctmTdsLR_2_2542_roptpi_2549 ( .A1 ( VectorX[3] ) , 
    .A2 ( n141 ) , .B ( n142 ) , .X ( S1S2mux[11] ) ) ;
SAEDLVT14_NR2_2 U66 ( .A1 ( n148 ) , .A2 ( S1S2mux[1] ) , .X ( newDist[0] ) ) ;
SAEDHVT14_ND2_MM_0P5 U67 ( .A1 ( n141 ) , .A2 ( n15 ) , .X ( S1S2mux[3] ) ) ;
SAEDRVT14_INV_0P5 U68 ( .A ( n135 ) , .X ( completed ) ) ;
SAEDRVT14_OAI21_0P75 U69 ( .A1 ( n140 ) , .A2 ( n21 ) , .B ( n137 ) , 
    .X ( VectorY[2] ) ) ;
SAEDRVT14_NR2_1 U70 ( .A1 ( count[9] ) , .A2 ( count[8] ) , .X ( n140 ) ) ;
SAEDRVT14_INV_0P5 U71 ( .A ( count[8] ) , .X ( VectorY[0] ) ) ;
SAEDHVT14_ND2_MM_0P5 U72 ( .A1 ( n149 ) , .A2 ( AddressS1[0] ) , .X ( n139 ) ) ;
SAEDRVT14_INV_S_0P5 U73 ( .A ( AddressR[4] ) , .X ( temp[4] ) ) ;
SAEDRVT14_INV_0P5 U74 ( .A ( count[10] ) , .X ( n21 ) ) ;
SAEDRVT14_INV_S_0P5 U75 ( .A ( AddressS1[2] ) , .X ( n16 ) ) ;
SAEDRVT14_INV_S_0P5 U76 ( .A ( AddressS1[1] ) , .X ( n13 ) ) ;
SAEDRVT14_INV_S_0P5 U77 ( .A ( AddressS1[0] ) , .X ( n8 ) ) ;
SAEDRVT14_INV_0P5 U78 ( .A ( count[12] ) , .X ( n10 ) ) ;
SAEDHVT14_ND2_MM_0P5 U79 ( .A1 ( AddressS1[0] ) , .A2 ( n13 ) , .X ( n145 ) ) ;
SAEDHVT14_ND2_MM_0P5 U80 ( .A1 ( AddressS1[1] ) , .A2 ( S1S2mux[12] ) , 
    .X ( n143 ) ) ;
SAEDRVT14_ND2_CDC_1 U81 ( .A1 ( start ) , .A2 ( n135 ) , .X ( n134 ) ) ;
SAEDHVT14_ND2_MM_0P5 U82 ( .A1 ( AddressS1[0] ) , .A2 ( AddressS1[1] ) , 
    .X ( n141 ) ) ;
SAEDRVT14_NR2_MM_0P5 ctmTdsLR_1_0 ( .A1 ( \sub_120/carry[10] ) , 
    .A2 ( count[10] ) , .X ( tmp_net1 ) ) ;
SAEDHVT14_ND2_MM_0P5 U84 ( .A1 ( AddressS1[2] ) , .A2 ( AddressS2[3] ) , 
    .X ( n142 ) ) ;
SAEDRVT14_OR3_0P5 U85 ( .A1 ( count[12] ) , .A2 ( count[11] ) , .A3 ( n137 ) , 
    .X ( CompStart ) ) ;
SAEDRVT14_AN2_MM_0P5 U86 ( .A1 ( temp[8] ) , .A2 ( temp[4] ) , 
    .X ( \add_121/carry[1] ) ) ;
SAEDRVT14_EO2_V1_0P75 U87 ( .A1 ( temp[4] ) , .A2 ( temp[8] ) , 
    .X ( AddressS2[5] ) ) ;
SAEDRVT14_EN2_V1_0P75 U90 ( .A1 ( \sub_120/carry[10] ) , .A2 ( count[10] ) , 
    .X ( temp[10] ) ) ;
SAEDRVT14_OR2_0P5 U91 ( .A1 ( \sub_120/carry[9] ) , .A2 ( count[9] ) , 
    .X ( \sub_120/carry[10] ) ) ;
SAEDRVT14_EN2_V1_0P75 U92 ( .A1 ( \sub_120/carry[9] ) , .A2 ( count[9] ) , 
    .X ( temp[9] ) ) ;
SAEDRVT14_OR2_0P5 U93 ( .A1 ( \sub_120/carry[8] ) , .A2 ( count[8] ) , 
    .X ( \sub_120/carry[9] ) ) ;
SAEDRVT14_EN2_V1_0P75 U94 ( .A1 ( \sub_120/carry[8] ) , .A2 ( count[8] ) , 
    .X ( temp[8] ) ) ;
SAEDRVT14_OR2_0P5 U95 ( .A1 ( \sub_120/carry[7] ) , .A2 ( AddressR[7] ) , 
    .X ( \sub_120/carry[8] ) ) ;
SAEDRVT14_EN2_V1_0P75 U96 ( .A1 ( \sub_120/carry[7] ) , .A2 ( AddressR[7] ) , 
    .X ( temp[7] ) ) ;
SAEDRVT14_OR2_0P5 U97 ( .A1 ( \sub_120/carry[6] ) , .A2 ( AddressR[6] ) , 
    .X ( \sub_120/carry[7] ) ) ;
SAEDRVT14_EN2_V1_0P75 U98 ( .A1 ( \sub_120/carry[6] ) , .A2 ( AddressR[6] ) , 
    .X ( temp[6] ) ) ;
SAEDRVT14_OR2_0P5 U99 ( .A1 ( AddressR[4] ) , .A2 ( AddressR[5] ) , 
    .X ( \sub_120/carry[6] ) ) ;
SAEDRVT14_EN2_V1_0P75 U100 ( .A1 ( AddressR[4] ) , .A2 ( AddressR[5] ) , 
    .X ( temp[5] ) ) ;
SAEDRVT14_AN2_MM_0P5 U101 ( .A1 ( count[8] ) , .A2 ( AddressR[4] ) , 
    .X ( \add_118/carry[1] ) ) ;
SAEDRVT14_EO2_V1_0P75 U102 ( .A1 ( AddressR[4] ) , .A2 ( count[8] ) , 
    .X ( AddressS1[5] ) ) ;
SAEDRVT14_OAI21_0P5 ctmTdsLR_2_2544_roptpi_2547 ( .A1 ( tmp_net10 ) , 
    .A2 ( tmp_net1 ) , .B ( tmp_net11 ) , .X ( tmp_net12 ) ) ;
SAEDRVT14_INV_0P5 ctmTdsLR_3_2545 ( .A ( count[11] ) , .X ( tmp_net10 ) ) ;
SAEDHVT14_ND2_MM_0P5 ctmTdsLR_4_2546 ( .A1 ( tmp_net1 ) , .A2 ( tmp_net10 ) , 
    .X ( tmp_net11 ) ) ;
endmodule
...
module PEtotal ( clock , R , S1 , S2 , S1S2mux , newDist , Accumulate , p0 , 
    p1 , ZCTSNET_1 , ZCTSNET_2 , ZCTSNET_3 , ZCTSNET_5 , p2 , p3 ) ;
input  clock ;
input  [7:0] R ;
input  [7:0] S1 ;
input  [7:0] S2 ;
...
PE_0 pe0 ( .clock ( ZCTSNET_5 ) , .R ( R ) , .S1 ( S1 ) , .S2 ( S2 ) , 
    .newDist ( newDist[0] ) , .Accumulate ( Accumulate[7:0] ) , 
    .Rpipe ( Rpipe0 ) , .p2 ( p2 ) , .p3 ( p3 ) ) ;
PE_14 pe1 ( .clock ( ZCTSNET_3 ) , .R ( Rpipe0 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
...
PE_12 pe3 ( .clock ( ZCTSNET_4 ) , .R ( Rpipe2 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
    .S1S2mux ( S1S2mux[3] ) , .newDist ( newDist[3] ) , 
    .Accumulate ( Accumulate[31:24] ) , .Rpipe ( Rpipe3 ) , 
    .ZCTSNET_0 ( ZCTSNET_5 ) ) ;
PE_11 pe4 ( .clock ( ZCTSNET_4 ) , .R ( Rpipe3 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
...
PE_3 pe12 ( .clock ( clock ) , .R ( Rpipe11 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
    ...
    .ZCTSNET_0 ( ZCTSNET_1 ) , .ZCTSNET_1 ( ZCTSNET_3 ) , 
    .ZCTSNET_2 ( ZCTSNET_5 ) ) ;
PE_2 pe13 ( .clock ( ZCTSNET_2 ) , .R ( Rpipe12 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
...
PE_1 pe14 ( .clock ( ZCTSNET_2 ) , .R ( Rpipe13 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
    ...
    .ZCTSNET_0 ( ZCTSNET_3 ) ) ;
PEend pe15 ( .clock ( ZCTSNET_2 ) , .R ( Rpipe14 ) , .S1 ( S1 ) , .S2 ( S2 ) , 
    .S1S2mux ( S1S2mux[15] ) , .newDist ( newDist[15] ) , 
    .Accumulate ( Accumulate[127:120] ) ) ;
SAEDRVT14_BUF_S_6 ZCTSBUF_1447_9 ( .A ( ZCTSNET_5 ) , .X ( ZCTSNET_0 ) ) ;
SAEDRVT14_BUF_10 ZCTSBUF_3131_13 ( .A ( ZCTSNET_5 ) , .X ( ZCTSNET_4 ) ) ;
endmodule
...
SAEDRVT14_FSDPSYNSBQ_V2LP_0P5 \Accumulate_reg[1] ( .SD ( n8 ) , .D ( Carry ) , 
    ...
    .Q ( Accumulate[1] ) ) ;
SAEDRVT14_AO22_0P5 U15 ( .A1 ( S1[1] ) , .A2 ( p3 ) , .B1 ( S2[1] ) , 
    .B2 ( n10 ) , .X ( N9 ) ) ;
SAEDRVT14_AO22_0P5 U16 ( .A1 ( S1[0] ) , .A2 ( p3 ) , .B1 ( S2[0] ) , 
    .B2 ( n10 ) , .X ( N8 ) ) ;
SAEDRVT14_AO22_0P5 U17 ( .A1 ( S1[7] ) , .A2 ( p3 ) , .B1 ( S2[7] ) , 
    .B2 ( n10 ) , .X ( N15 ) ) ;
SAEDRVT14_AO22_0P5 U18 ( .A1 ( S1[6] ) , .A2 ( p2 ) , .B1 ( S2[6] ) , 
    .B2 ( n10 ) , .X ( N14 ) ) ;
SAEDRVT14_AO22_0P5 U19 ( .A1 ( S1[5] ) , .A2 ( p2 ) , .B1 ( S2[5] ) , 
    .B2 ( n10 ) , .X ( N13 ) ) ;
SAEDRVT14_AO22_0P5 U20 ( .A1 ( S1[4] ) , .A2 ( p2 ) , .B1 ( S2[4] ) , 
    .B2 ( n10 ) , .X ( N12 ) ) ;
SAEDRVT14_AO22_0P5 U21 ( .A1 ( S1[3] ) , .A2 ( p2 ) , .B1 ( S2[3] ) , 
    .B2 ( n10 ) , .X ( N11 ) ) ;
SAEDRVT14_AO22_0P5 U22 ( .A1 ( S1[2] ) , .A2 ( p3 ) , .B1 ( S2[2] ) , 
    .B2 ( n10 ) , .X ( N10 ) ) ;
PE_0_DW01_add_0 add_47 (
...
SAEDRVT14_INV_S_0P5 U4 ( .A ( N29 ) , .X ( n6 ) ) ;
SAEDRVT14_INV_S_0P5 U5 ( .A ( N30 ) , .X ( n5 ) ) ;
SAEDRVT14_INV_S_0P5 U6 ( .A ( N33 ) , .X ( n1 ) ) ;
SAEDRVT14_INV_S_0P5 U7 ( .A ( N31 ) , .X ( n3 ) ) ;
SAEDRVT14_INV_S_0P5 U8 ( .A ( N32 ) , .X ( n2 ) ) ;
SAEDRVT14_INV_S_0P5 U9 ( .A ( N28 ) , .X ( n7 ) ) ;
...
SAEDRVT14_ADDF_V1_0P5 U2_1 ( .A ( A[1] ) , .B ( n2 ) , .CI ( n1 ) , 
    .CO ( carry[2] ) , .S ( DIFF[1] ) ) ;
SAEDRVT14_OR2_0P5 U1 ( .A1 ( A[0] ) , .A2 ( n3 ) , .X ( n1 ) ) ;
...
SAEDRVT14_ADDF_V1_0P5 U2_1 ( .A ( A[1] ) , .B ( n2 ) , .CI ( n1 ) , 
    .CO ( carry[2] ) , .S ( DIFF[1] ) ) ;
SAEDRVT14_OR2_MM_0P5 U1 ( .A1 ( A[0] ) , .A2 ( n3 ) , .X ( n1 ) ) ;
...
SAEDRVT14_INV_S_0P5 U9 ( .A ( B[0] ) , .X ( n3 ) ) ;
SAEDRVT14_INV_S_0P5 U10 ( .A ( B[7] ) , .X ( n4 ) ) ;
endmodule
...
PE_13_DW01_add_0 add_47 (
    ...
    .B ( { SYNOPSYS_UNCONNECTED_2 , difference[7] , difference[6] , 
        ...
        difference[1] , difference[0] } ) ,
    .SUM ( { Carry , N33 , N32 , N31 , N30 , N29 , N28 , N27 , N26 } ) ) ;
PE_13_DW01_sub_1 sub_41 ( .A ( R ) ,
    .B ( { N15 , N14 , N13 , N12 , N11 , N10 , N9 , N8 } ) ,
    .DIFF ( difference ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[7] ( .D ( R[7] ) , .CK ( ZCTSNET_1 ) , 
    .Q ( Rpipe[7] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[6] ( .D ( R[6] ) , .CK ( ZCTSNET_1 ) , 
    .Q ( Rpipe[6] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[5] ( .D ( R[5] ) , .CK ( ZCTSNET_1 ) , 
    .Q ( Rpipe[5] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[4] ( .D ( R[4] ) , .CK ( ZCTSNET_1 ) , 
    .Q ( Rpipe[4] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[3] ( .D ( R[3] ) , .CK ( ZCTSNET_1 ) , 
    .Q ( Rpipe[3] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[2] ( .D ( R[2] ) , .CK ( clock ) , 
    .Q ( Rpipe[2] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[1] ( .D ( R[1] ) , .CK ( clock ) , 
...
SAEDRVT14_OR2_MM_0P5 U1 ( .A1 ( A[0] ) , .A2 ( n3 ) , .X ( n1 ) ) ;
SAEDRVT14_INV_S_0P5 U2 ( .A ( B[0] ) , .X ( n3 ) ) ;
SAEDRVT14_INV_S_0P5 U3 ( .A ( B[1] ) , .X ( n2 ) ) ;
...
SAEDRVT14_EN2_0P5 U9 ( .A1 ( n3 ) , .A2 ( A[0] ) , .X ( DIFF[0] ) ) ;
SAEDRVT14_INV_S_0P5 U10 ( .A ( B[7] ) , .X ( n4 ) ) ;
endmodule
...
SAEDRVT14_INV_S_0P5 U9 ( .A ( N32 ) , .X ( n2 ) ) ;
SAEDRVT14_INV_S_0P5 U10 ( .A ( N33 ) , .X ( n1 ) ) ;
SAEDRVT14_INV_S_0P5 U11 ( .A ( S1S2mux ) , .X ( n10 ) ) ;
SAEDRVT14_INV_S_0P5 U12 ( .A ( N26 ) , .X ( n9 ) ) ;
endmodule
...
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[6] ( .D ( R[6] ) , .CK ( ZCTSNET_1 ) , 
    .Q ( Rpipe[6] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[5] ( .D ( R[5] ) , .CK ( ZCTSNET_2 ) , 
    .Q ( Rpipe[5] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[4] ( .D ( R[4] ) , .CK ( ZCTSNET_2 ) , 
    .Q ( Rpipe[4] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[3] ( .D ( R[3] ) , .CK ( clock ) , 
    .Q ( Rpipe[3] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \Rpipe_reg[2] ( .D ( R[2] ) , .CK ( clock ) , 
...
module Comparator ( clock , CompStart , PEout , PEready , vectorX , vectorY , 
    BestDist , motionX , motionY , ZCTSNET_0 , ZCTSNET_1 , ZCTSNET_2 ) ;
input  clock ;
input  CompStart ;
input  [127:0] PEout ;
input  [15:0] PEready ;
...
SAEDRVT14_AO22_0P75 U10 ( .A1 ( vectorY[2] ) , .A2 ( n136 ) , 
    .B1 ( motionY[2] ) , .B2 ( n7 ) , .X ( n116 ) ) ;
SAEDRVT14_AO22_0P75 U11 ( .A1 ( vectorY[3] ) , .A2 ( n136 ) , 
...
SAEDRVT14_AO21B_0P5 U64 ( .A1 ( PEout[77] ) , .A2 ( n15 ) , .B ( n67 ) , 
    .X ( n66 ) ) ;
SAEDRVT14_AO22_0P5 U67 ( .A1 ( PEout[53] ) , .A2 ( PEready[6] ) , 
...
SAEDRVT14_AO21B_0P5 U76 ( .A1 ( PEout[78] ) , .A2 ( n15 ) , .B ( n77 ) , 
    .X ( n76 ) ) ;
SAEDRVT14_AO22_0P5 U79 ( .A1 ( PEout[54] ) , .A2 ( PEready[6] ) , 
...
SAEDRVT14_FDP_V2LP_1 \motionY_reg[0] ( .D ( n114 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( motionY[0] ) ) ;
SAEDRVT14_FDP_V2LP_1 \motionY_reg[1] ( .D ( n115 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( motionY[1] ) ) ;
SAEDRVT14_FDP_V2LP_1 \motionY_reg[2] ( .D ( n116 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( motionY[2] ) ) ;
SAEDRVT14_FDP_V2LP_0P5 \motionY_reg[3] ( .D ( n117 ) , .CK ( ZCTSNET_2 ) , 
    .Q ( motionY[3] ) ) ;
SAEDRVT14_FDP_V2LP_1 \motionX_reg[3] ( .D ( n113 ) , .CK ( ZCTSNET_0 ) , 
    .Q ( motionX[3] ) ) ;
SAEDRVT14_FDP_V2LP_1 \motionX_reg[2] ( .D ( n112 ) , .CK ( ZCTSNET_0 ) , 
    .Q ( motionX[2] ) ) ;
SAEDRVT14_FDP_V2LP_1 \motionX_reg[1] ( .D ( n111 ) , .CK ( ZCTSNET_0 ) , 
    .Q ( motionX[1] ) ) ;
SAEDRVT14_FDP_V2LP_1 \motionX_reg[0] ( .D ( n110 ) , .CK ( clock ) , 
    .Q ( motionX[0] ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[0] ( .D ( n125 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[0] ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[1] ( .D ( n118 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[1] ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[2] ( .D ( n119 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[2] ) , .QN ( n5 ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[3] ( .D ( n120 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[3] ) , .QN ( n1 ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[4] ( .D ( n121 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[4] ) , .QN ( n6 ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[5] ( .D ( n122 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[5] ) , .QN ( n2 ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[6] ( .D ( n123 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[6] ) , .QN ( n4 ) ) ;
SAEDRVT14_FDP_V2LP_1 \BestDist_reg[7] ( .D ( n124 ) , .CK ( ZCTSNET_1 ) , 
    .Q ( BestDist[7] ) , .QN ( n3 ) ) ;
SAEDRVT14_INV_0P5 U4 ( .A ( n100 ) , .X ( n137 ) ) ;
SAEDRVT14_INV_0P5 U12 ( .A ( PEready[4] ) , .X ( n138 ) ) ;
SAEDRVT14_NR3B_1 U13 ( .A ( PEready[11] ) , .B1 ( PEready[13] ) , 
    .B2 ( PEready[12] ) , .X ( n13 ) ) ;
SAEDRVT14_NR3B_1 U15 ( .A ( PEready[9] ) , .B1 ( PEready[10] ) , 
    .B2 ( n106 ) , .X ( n15 ) ) ;
SAEDRVT14_NR2_1 U17 ( .A1 ( n104 ) , .A2 ( PEready[1] ) , .X ( n23 ) ) ;
SAEDRVT14_NR2_1 U18 ( .A1 ( PEready[5] ) , .A2 ( PEready[6] ) , .X ( n102 ) ) ;
SAEDRVT14_NR3B_1 U20 ( .A ( n102 ) , .B1 ( PEready[4] ) , .B2 ( PEready[3] ) , 
    .X ( n105 ) ) ;
SAEDRVT14_NR2_1 U22 ( .A1 ( n109 ) , .A2 ( PEready[8] ) , .X ( n108 ) ) ;
SAEDRVT14_NR2_1 ctmTdsLR_1_2535 ( .A1 ( tmp_net6 ) , .A2 ( n104 ) , 
    .X ( n26 ) ) ;
SAEDRVT14_INV_0P5 U25 ( .A ( CompStart ) , .X ( n139 ) ) ;
SAEDRVT14_OAI311_0P5 U27 ( .A1 ( n27 ) , .A2 ( n100 ) , .A3 ( n12 ) , 
    .B1 ( CompStart ) , .B2 ( N169 ) , .X ( n7 ) ) ;
SAEDRVT14_OAI21_0P75 U29 ( .A1 ( n98 ) , .A2 ( n99 ) , .B ( n137 ) , 
    .X ( n97 ) ) ;
SAEDRVT14_AO221_0P5 U30 ( .A1 ( PEout[40] ) , .A2 ( n19 ) , 
    .B1 ( PEout[32] ) , .B2 ( n20 ) , .C ( n101 ) , .X ( n99 ) ) ;
SAEDRVT14_AO221_0P5 U32 ( .A1 ( PEout[0] ) , .A2 ( n23 ) , .B1 ( PEout[16] ) , 
    .B2 ( n24 ) , .C ( n103 ) , .X ( n98 ) ) ;
SAEDRVT14_OAI21_0P75 U34 ( .A1 ( n17 ) , .A2 ( n18 ) , .B ( n137 ) , 
    .X ( n16 ) ) ;
SAEDRVT14_AO221_0P5 U36 ( .A1 ( PEout[41] ) , .A2 ( n19 ) , 
    .B1 ( PEout[33] ) , .B2 ( n20 ) , .C ( n21 ) , .X ( n18 ) ) ;
SAEDRVT14_AO221_0P5 U37 ( .A1 ( PEout[1] ) , .A2 ( n23 ) , .B1 ( PEout[17] ) , 
    .B2 ( n24 ) , .C ( n25 ) , .X ( n17 ) ) ;
SAEDRVT14_OAI21_0P5 U39 ( .A1 ( n48 ) , .A2 ( n49 ) , .B ( n137 ) , 
    .X ( n47 ) ) ;
SAEDRVT14_AO221_0P5 U41 ( .A1 ( PEout[43] ) , .A2 ( n19 ) , 
    .B1 ( PEout[35] ) , .B2 ( n20 ) , .C ( n50 ) , .X ( n49 ) ) ;
SAEDRVT14_AO221_0P5 U42 ( .A1 ( PEout[3] ) , .A2 ( n23 ) , .B1 ( PEout[19] ) , 
    .B2 ( n24 ) , .C ( n51 ) , .X ( n48 ) ) ;
SAEDRVT14_OAI21_0P5 U44 ( .A1 ( n58 ) , .A2 ( n59 ) , .B ( n137 ) , 
    .X ( n57 ) ) ;
SAEDRVT14_AO221_0P5 U46 ( .A1 ( PEout[44] ) , .A2 ( n19 ) , 
    .B1 ( PEout[36] ) , .B2 ( n20 ) , .C ( n60 ) , .X ( n59 ) ) ;
SAEDRVT14_AO221_0P5 U48 ( .A1 ( PEout[4] ) , .A2 ( n23 ) , .B1 ( PEout[20] ) , 
    .B2 ( n24 ) , .C ( n61 ) , .X ( n58 ) ) ;
SAEDRVT14_OAI21_0P75 U49 ( .A1 ( n78 ) , .A2 ( n79 ) , .B ( n137 ) , 
    .X ( n77 ) ) ;
SAEDRVT14_AO221_0P5 U51 ( .A1 ( PEout[46] ) , .A2 ( n19 ) , 
    .B1 ( PEout[38] ) , .B2 ( n20 ) , .C ( n80 ) , .X ( n79 ) ) ;
SAEDRVT14_AO221_0P5 U53 ( .A1 ( PEout[6] ) , .A2 ( n23 ) , .B1 ( PEout[22] ) , 
    .B2 ( n24 ) , .C ( n81 ) , .X ( n78 ) ) ;
SAEDRVT14_OAI21_0P75 U54 ( .A1 ( n38 ) , .A2 ( n39 ) , .B ( n137 ) , 
    .X ( n37 ) ) ;
SAEDRVT14_AO221_0P5 U56 ( .A1 ( PEout[42] ) , .A2 ( n19 ) , 
    .B1 ( PEout[34] ) , .B2 ( n20 ) , .C ( n40 ) , .X ( n39 ) ) ;
SAEDRVT14_AO221_0P5 U58 ( .A1 ( PEout[2] ) , .A2 ( n23 ) , .B1 ( PEout[18] ) , 
    .B2 ( n24 ) , .C ( n41 ) , .X ( n38 ) ) ;
SAEDRVT14_OAI21_0P75 U60 ( .A1 ( n68 ) , .A2 ( n69 ) , .B ( n137 ) , 
    .X ( n67 ) ) ;
SAEDRVT14_AO221_0P5 U61 ( .A1 ( PEout[45] ) , .A2 ( n19 ) , 
    .B1 ( PEout[37] ) , .B2 ( n20 ) , .C ( n70 ) , .X ( n69 ) ) ;
SAEDRVT14_AO221_0P5 U63 ( .A1 ( PEout[5] ) , .A2 ( n23 ) , .B1 ( PEout[21] ) , 
    .B2 ( n24 ) , .C ( n71 ) , .X ( n68 ) ) ;
SAEDRVT14_OAI21_0P75 U65 ( .A1 ( n88 ) , .A2 ( n89 ) , .B ( n137 ) , 
    .X ( n87 ) ) ;
...
SAEDRVT14_AO221_0P5 U68 ( .A1 ( PEout[7] ) , .A2 ( n23 ) , .B1 ( PEout[23] ) , 
    .B2 ( n24 ) , .C ( n91 ) , .X ( n88 ) ) ;
SAEDRVT14_AO221_0P5 U70 ( .A1 ( PEout[113] ) , .A2 ( n8 ) , 
    .B1 ( PEout[121] ) , .B2 ( PEready[15] ) , .C ( n9 ) , .X ( newDist[1] ) ) ;
SAEDRVT14_AO221_0P5 U72 ( .A1 ( PEout[65] ) , .A2 ( n28 ) , 
    .B1 ( PEout[57] ) , .B2 ( n29 ) , .C ( n30 ) , .X ( n10 ) ) ;
SAEDRVT14_AO221_0P5 U73 ( .A1 ( PEout[89] ) , .A2 ( n13 ) , 
    .B1 ( PEout[105] ) , .B2 ( PEready[13] ) , .C ( n14 ) , .X ( n11 ) ) ;
SAEDRVT14_AO221_0P5 U75 ( .A1 ( PEout[118] ) , .A2 ( n8 ) , 
    .B1 ( PEout[126] ) , .B2 ( PEready[15] ) , .C ( n73 ) , 
    .X ( newDist[6] ) ) ;
SAEDRVT14_AO221_0P5 U77 ( .A1 ( PEout[70] ) , .A2 ( n28 ) , 
    .B1 ( PEout[62] ) , .B2 ( n29 ) , .C ( n82 ) , .X ( n74 ) ) ;
SAEDRVT14_AO221_0P5 U78 ( .A1 ( PEout[94] ) , .A2 ( n13 ) , 
    .B1 ( PEout[110] ) , .B2 ( PEready[13] ) , .C ( n76 ) , .X ( n75 ) ) ;
SAEDRVT14_AO221_0P5 U80 ( .A1 ( PEout[114] ) , .A2 ( n8 ) , 
    .B1 ( PEout[122] ) , .B2 ( PEready[15] ) , .C ( n33 ) , 
    .X ( newDist[2] ) ) ;
SAEDRVT14_AO221_0P5 U82 ( .A1 ( PEout[66] ) , .A2 ( n28 ) , 
    .B1 ( PEout[58] ) , .B2 ( n29 ) , .C ( n42 ) , .X ( n34 ) ) ;
SAEDRVT14_AO221_0P5 U84 ( .A1 ( PEout[90] ) , .A2 ( n13 ) , 
    .B1 ( PEout[106] ) , .B2 ( PEready[13] ) , .C ( n36 ) , .X ( n35 ) ) ;
SAEDRVT14_AO221_0P5 U85 ( .A1 ( PEout[116] ) , .A2 ( n8 ) , 
    .B1 ( PEout[124] ) , .B2 ( PEready[15] ) , .C ( n53 ) , 
    .X ( newDist[4] ) ) ;
SAEDRVT14_AO221_0P5 U87 ( .A1 ( PEout[68] ) , .A2 ( n28 ) , 
    .B1 ( PEout[60] ) , .B2 ( n29 ) , .C ( n62 ) , .X ( n54 ) ) ;
SAEDRVT14_AO221_0P5 U89 ( .A1 ( PEout[92] ) , .A2 ( n13 ) , 
    .B1 ( PEout[108] ) , .B2 ( PEready[13] ) , .C ( n56 ) , .X ( n55 ) ) ;
SAEDRVT14_AO221_0P5 U90 ( .A1 ( PEout[119] ) , .A2 ( n8 ) , 
    .B1 ( PEready[15] ) , .B2 ( PEout[127] ) , .C ( n83 ) , 
    .X ( newDist[7] ) ) ;
SAEDRVT14_AO221_0P5 U92 ( .A1 ( PEout[71] ) , .A2 ( n28 ) , 
    .B1 ( PEout[63] ) , .B2 ( n29 ) , .C ( n92 ) , .X ( n84 ) ) ;
SAEDRVT14_AO221_0P5 U94 ( .A1 ( PEout[95] ) , .A2 ( n13 ) , 
    .B1 ( PEready[13] ) , .B2 ( PEout[111] ) , .C ( n86 ) , .X ( n85 ) ) ;
SAEDRVT14_AO221_0P5 U96 ( .A1 ( PEout[115] ) , .A2 ( n8 ) , 
    .B1 ( PEout[123] ) , .B2 ( PEready[15] ) , .C ( n43 ) , 
    .X ( newDist[3] ) ) ;
SAEDRVT14_AO221_0P5 U97 ( .A1 ( PEout[67] ) , .A2 ( n28 ) , 
    .B1 ( PEout[59] ) , .B2 ( n29 ) , .C ( n52 ) , .X ( n44 ) ) ;
SAEDRVT14_AO221_0P5 U99 ( .A1 ( PEout[91] ) , .A2 ( n13 ) , 
    .B1 ( PEout[107] ) , .B2 ( PEready[13] ) , .C ( n46 ) , .X ( n45 ) ) ;
SAEDRVT14_AO221_0P5 U101 ( .A1 ( PEout[117] ) , .A2 ( n8 ) , 
    .B1 ( PEout[125] ) , .B2 ( PEready[15] ) , .C ( n63 ) , 
    .X ( newDist[5] ) ) ;
SAEDRVT14_AO221_0P5 U102 ( .A1 ( PEout[69] ) , .A2 ( n28 ) , 
    .B1 ( PEout[61] ) , .B2 ( n29 ) , .C ( n72 ) , .X ( n64 ) ) ;
SAEDRVT14_AO221_0P5 U107 ( .A1 ( PEout[93] ) , .A2 ( n13 ) , 
    .B1 ( PEout[109] ) , .B2 ( PEready[13] ) , .C ( n66 ) , .X ( n65 ) ) ;
SAEDRVT14_AO221_0P5 U111 ( .A1 ( PEout[112] ) , .A2 ( n8 ) , 
    .B1 ( PEout[120] ) , .B2 ( PEready[15] ) , .C ( n93 ) , 
    .X ( newDist[0] ) ) ;
SAEDRVT14_AO221_0P5 U112 ( .A1 ( PEout[64] ) , .A2 ( n28 ) , 
    .B1 ( PEout[56] ) , .B2 ( n29 ) , .C ( n107 ) , .X ( n94 ) ) ;
SAEDRVT14_AO221_0P5 U113 ( .A1 ( PEout[88] ) , .A2 ( n13 ) , 
    .B1 ( PEout[104] ) , .B2 ( PEready[13] ) , .C ( n96 ) , .X ( n95 ) ) ;
SAEDRVT14_AO221_0P5 U120 ( .A1 ( n136 ) , .A2 ( newDist[7] ) , 
    .B1 ( BestDist[7] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n124 ) ) ;
SAEDRVT14_AO221_0P5 U123 ( .A1 ( n136 ) , .A2 ( newDist[6] ) , 
    .B1 ( BestDist[6] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n123 ) ) ;
SAEDRVT14_AO221_0P5 U127 ( .A1 ( n136 ) , .A2 ( newDist[5] ) , 
    .B1 ( BestDist[5] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n122 ) ) ;
SAEDRVT14_AO221_0P5 U129 ( .A1 ( n136 ) , .A2 ( newDist[4] ) , 
    .B1 ( BestDist[4] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n121 ) ) ;
SAEDRVT14_AO221_0P5 U130 ( .A1 ( n136 ) , .A2 ( newDist[3] ) , 
    .B1 ( BestDist[3] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n120 ) ) ;
SAEDRVT14_AO221_0P5 U131 ( .A1 ( n136 ) , .A2 ( newDist[2] ) , 
    .B1 ( BestDist[2] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n119 ) ) ;
SAEDRVT14_AO221_0P5 U132 ( .A1 ( n136 ) , .A2 ( newDist[1] ) , 
    .B1 ( BestDist[1] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n118 ) ) ;
SAEDRVT14_AO221_0P5 U133 ( .A1 ( n136 ) , .A2 ( newDist[0] ) , 
    .B1 ( BestDist[0] ) , .B2 ( n7 ) , .C ( n139 ) , .X ( n125 ) ) ;
SAEDRVT14_INV_0P5 U134 ( .A ( n7 ) , .X ( n136 ) ) ;
SAEDRVT14_ND2B_U_0P5 U135 ( .A ( newDist[0] ) , .B ( BestDist[0] ) , 
    .X ( n128 ) ) ;
SAEDRVT14_OA21B_1 U136 ( .A1 ( n128 ) , .A2 ( newDist[1] ) , 
    .B ( BestDist[1] ) , .X ( n127 ) ) ;
SAEDRVT14_AO221_0P5 U137 ( .A1 ( newDist[1] ) , .A2 ( n128 ) , 
    .B1 ( newDist[2] ) , .B2 ( n5 ) , .C ( n127 ) , .X ( n129 ) ) ;
SAEDRVT14_OA221_U_0P5 U138 ( .A1 ( newDist[3] ) , .A2 ( n1 ) , 
    .B1 ( newDist[2] ) , .B2 ( n5 ) , .C ( n129 ) , .X ( n130 ) ) ;
SAEDRVT14_AO221_0P5 U139 ( .A1 ( newDist[3] ) , .A2 ( n1 ) , 
    .B1 ( newDist[4] ) , .B2 ( n6 ) , .C ( n130 ) , .X ( n131 ) ) ;
SAEDRVT14_OA221_U_0P5 U140 ( .A1 ( newDist[5] ) , .A2 ( n2 ) , 
    .B1 ( newDist[4] ) , .B2 ( n6 ) , .C ( n131 ) , .X ( n132 ) ) ;
SAEDRVT14_AO221_0P5 U141 ( .A1 ( newDist[5] ) , .A2 ( n2 ) , 
    .B1 ( newDist[6] ) , .B2 ( n4 ) , .C ( n132 ) , .X ( n133 ) ) ;
SAEDRVT14_OAI21_0P75 U142 ( .A1 ( newDist[6] ) , .A2 ( n4 ) , .B ( n133 ) , 
    .X ( n134 ) ) ;
SAEDRVT14_AO21B_0P5 U143 ( .A1 ( n3 ) , .A2 ( newDist[7] ) , .B ( n134 ) , 
    .X ( n135 ) ) ;
SAEDRVT14_OAI21_0P75 U144 ( .A1 ( newDist[7] ) , .A2 ( n3 ) , .B ( n135 ) , 
    .X ( N169 ) ) ;
SAEDRVT14_INV_0P5 ctmTdsLR_2_2536 ( .A ( PEready[1] ) , .X ( tmp_net6 ) ) ;
SAEDRVT14_INV_0P5 ctmTdsLR_2_2538 ( .A ( PEready[12] ) , .X ( tmp_net7 ) ) ;
endmodule
